...
var save_device_controller_exports = {};
__export(save_device_controller_exports, {
  saveDeviceController: () => saveDeviceController
});
module.exports = __toCommonJS(save_device_controller_exports);
